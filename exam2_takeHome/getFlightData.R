...
#[16] "DEST_STATE_ABR"        "CRS_DEP_TIME"          "CANCELLED"
#[19] "ARR_DELAY"               
# Click "Download"
...
# This next step took me approx. 177 seconds
 ...
 cat('total time: ',end-srt)
  ...
  #From the rest of this exam, you can just load the R object to get all the flights.
load(file="./2014flights.Rdata")
#just to see the size of object in memory.  
#    - Mine is 599.7 MB
#    - Yours may be somewhat different if you selected different options from transtats
#    - If your file is substantially different from 600 MB, something likely is wrong
